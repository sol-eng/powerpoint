...
These rules are designed to support many different styles of slide show. If you don’t care about structuring your slides into sections and subsections, you can just use level 1 headers for each slide. (In that case, level 1 will be the slide level.) But you can also structure the slide show into sections. See [Structuring the slide show](http://pandoc.org/MANUAL.html#structuring-the-slide-show) for details.
